...
public enum ImshabyApiEndpoint {
    ...
    GET_MASS_WEEK_PARAM("Получение расписания служб по ключу парафии в параметрах", "/api/mass/week", Method.GET, new FieldValueSetter.Default(),
            new MassResponseDtoMapping(), RequestParam.API_KEY),
    GET_MASS_WEEK_HEADER("Получение расписания служб по ключу парафии в заголовках", "/api/mass/week", Method.GET, new FieldValueSetter.Default(),
            new MassResponseDtoMapping()),
