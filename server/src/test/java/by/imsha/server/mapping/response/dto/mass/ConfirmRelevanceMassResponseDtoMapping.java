...
public class ConfirmRelevanceMassResponseDtoMapping implements FieldNameGetter {
    ...
    public String getFieldName(String fieldQualifier) {
        ...
        throw new IllegalArgumentException("Неизвестное поле '" + fieldQualifier + "' в модели ответа обновления служб");
    }
}