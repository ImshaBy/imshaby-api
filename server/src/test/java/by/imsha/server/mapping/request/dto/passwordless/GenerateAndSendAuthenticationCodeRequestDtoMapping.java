...
public class GenerateAndSendAuthenticationCodeRequestDtoMapping implements FieldValueSetter {
    ...
    public ObjectNode apply(ObjectNode jsonNode, String fieldName, Object fieldValue) {
        ...
        throw new IllegalArgumentException("Неизвестное поле '" + fieldName + "' в модели запроса генерации и отправки кода аутентификации");
    }
}
