package by.imsha.server.rest.passwordless;

import by.imsha.server.properties.PasswordlessApiProperties;
import by.imsha.server.rest.passwordless.send.CodeSender;
import by.imsha.server.rest.passwordless.send.ConsoleCodeSender;
import by.imsha.server.rest.passwordless.send.EmailCodeSender;
