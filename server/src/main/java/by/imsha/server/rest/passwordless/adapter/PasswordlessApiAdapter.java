...
import by.imsha.server.rest.passwordless.adapter.request.GenerateCodeInternalRequest;
import by.imsha.server.rest.passwordless.adapter.request.LoginRequest;
import by.imsha.server.rest.passwordless.adapter.request.StartRequest;
import by.imsha.server.rest.passwordless.adapter.response.GenerateCodeInternalResponse;
import by.imsha.server.rest.passwordless.adapter.response.LoginResponse;
...
import by.imsha.server.rest.passwordless.send.InterceptingCodeSender;
